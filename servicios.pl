use IO::Socket;
$servidor="207.44.227.14";
$puerto=4400;
$pass="openaccess";
$canaldebug="#opers";
$msgkill="Publicidad no Permitida en 24h-non-stop";
$nombre="pitch.black";
$numerico="90";
...
if (@datos[3] =~/BOTS/i) {
 ...
 print $socket "${numerico}AG P $trio : 4MeMO Servicio de mensajerú} entre usuarios.\n";
 print $socket "${numerico}AG P $trio : 4SHaDoW Servicio de guardú}n de modos.\n";
 ...
 print $socket "${numerico}AG P $trio : 4GLoBaL Servicio de mensajerú} global.\n";
